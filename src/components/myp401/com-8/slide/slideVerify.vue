<template>
        ...
        <div class="slide-verify-slider-mask" :style="{ width: sliderMaskWidth }">
          ...
          >
            <div class="slide-verify-slider-mask-item-icon ">
                <slot name="mask" style="pointer-events: none;"></slot>
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      handleMoveEvent: throttle(function(e, type = "mouse") {
        ...
        let blockLeft = ((this.w - 40 - 0) / (this.w - 40)) * moveX;
  ...
  .slide-verify-slider-mask-item:active {
    background: #1991fa;
  }
  
  .slide-verify-slider-mask-item:active .slide-verify-slider-mask-item-icon {
